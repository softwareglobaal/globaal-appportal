...
bron: werkwijze/agenda-taken.json v{t['versie']} en werkwijze v7.13 op de server</div>
<h1>De Agendawacht: afspraken, kleuren en taken</h1>

<div class=kader>
Dit document zegt hoe de Agendawacht nu werkt. Het vervangt versie 2.9 en ouder en het voorlopige blad 'nieuwe afspraken' (0.5 tot 0.16).
...
<li><b>Kleurherstel om :17 en :47, ook 's nachts en in het weekend.</b> Elke 30 minuten, om :15 en :45 UTC, zet iets buiten de
agent, rechtstreeks bij Google, alle UNABO- en TKNB-afspraken van de komende vier weken op paars en geel. Twee minuten later zet
het kleurherstel ze terug, 29 dagen vooruit. De bron uitzetten kan alleen Mehdi (FR-21).</li>
</ul>
