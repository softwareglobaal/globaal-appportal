...
Zeg "     die persoon en ziet hij diens applicaties. Zonder foutmelding."
...
Zeg "  4. Controle in de chat: vraag 'welke applicaties mag ik lezen'."
Zeg "     Klopt het antwoord niet met de tegels die hij op het portaal ziet,"
Zeg "     dan is stap 1 misgegaan."
Zeg ""
