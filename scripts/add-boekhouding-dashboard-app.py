"""Registreer de tegel Boekhouding-dashboard in Authentik (forward-auth
proxy-provider).

Draaien (vanuit ~/appportal):
  sh scripts/ak-exec.sh scripts/add-boekhouding-dashboard-app.py

Idempotent: veilig om opnieuw te draaien. Maakt de tegel 'Boekhouding-dashboard'
in de launcher, toegankelijk voor de groepen admin/manager/boekhouding, dezelfde
kring als de Boekhouding-app. De app leest de gebruiker uit de X-authentik-*
headers en controleert zelf nog eens op de groep.
"""
import os
...
SLUG = "boekhouding-dashboard"
NAME = "Boekhouding-dashboard"
...
outpost.save()
print("embedded outpost: boekhouding-dashboard-proxy toegevoegd")
print("BOEKHOUDING_DASHBOARD_APP_DONE")
