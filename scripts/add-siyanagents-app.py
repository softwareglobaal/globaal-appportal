...
SLUG, NAME, SUB = "siyanagents", "Sales/Marketing agents", "siyanagents"
# Eigen groep voor dit team (aparte toegang, los van de operations-agents);
# admin/manager erbij zodat beheerders er altijd bij kunnen (geen lockout).
