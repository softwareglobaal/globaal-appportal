"""Registreer de Contactsync-statuspagina in Authentik (forward-auth).

Draaien (vanuit ~/appportal):
  sh scripts/ak-exec.sh scripts/add-contactsync-app.py

Idempotent: veilig om opnieuw te draaien. Maakt de tegel 'Contactsync'
in de launcher, toegankelijk voor de groepen admin/manager. De pagina is
alleen-lezen monitoring van de Google->Xelion contactsynchronisatie.
"""
import os
...
outpost.save()
print("embedded outpost: contactsync-proxy toegevoegd")
print("CONTACTSYNC_APP_DONE")
