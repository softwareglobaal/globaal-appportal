...
SLUG, NAME, SUB, GROUP = "uitgaven", "AI-uitgaven", "uitgaven", "uitgaven"
...
for uname in ["mehdi", "siyan", "akadmin"]:
...
print(f"uitgaven app: {'created' if created else 'exists'} | groep={GROUP}")
print("UITGAVEN_APP_DONE")
