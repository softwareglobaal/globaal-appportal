"""Registreer het Draaiboeks-dashboard in Authentik (forward-auth proxy-provider).

Draaien (vanuit ~/appportal):
  docker compose cp scripts/add-draaiboek-app.py authentik-server:/tmp/v.py
...
Group.objects.get_or_create(name="draaiboek-editors")
print("groep draaiboek-editors: aanwezig")
