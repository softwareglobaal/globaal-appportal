...
MERKEN = [
    {"naam": 'H-Architects', "sector": 'Architectuur', "web": 'https://h-architects.be', "typo": 'Systeem-sans, minimalistisch', "bron": 'visueel vastgesteld (monochroom, geen merkkleur in CSS/logo)',
     "kleuren": [{"hex": "#1c1c1c", "rol": "Antraciet — koppen/tekst"}, {"hex": "#ffffff", "rol": "Wit — basis"}, {"hex": "#555659", "rol": "Grijs — secundair"}],
     ...
     "look": 'Wit met antraciet, veel witruimte, architectuurvisualisaties dragen de pagina.'},
    {"naam": 'HDS-India', "sector": 'Architectuur / 3D-design', "web": 'https://highdesignstudio.in', "typo": 'Minimalistisch sans', "bron": 'niet verifieerbaar (SSL-certificaat kapot, site laadt niet betrouwbaar)',
     "kleuren": [{"hex": "#111111", "rol": "Zwart — tekst"}, {"hex": "#ffffff", "rol": "Wit — basis"}],
     "pos": 'Ontwerp en uitvoering; branch van het Belgische H-Architects (Leuven/Rotterdam/Delhi).',
     "tone": "Visiegedreven, internationaal: 'tradition fused with modernity'.",
     "look": 'HDS-groepsstijl: minimalistisch, wit, 3D-renders. LET OP: SSL-certificaat defect.'},
    {"naam": 'HDS-Suriname', "sector": 'Architectuur / 3D-design', "web": 'https://www.hdssr.com', "typo": 'Minimalistisch sans', "bron": 'visueel vastgesteld (monochroom; beeld draagt de identiteit)',
     "kleuren": [{"hex": "#1a1a1a", "rol": "Zwart — tekst"}, {"hex": "#ffffff", "rol": "Wit — basis"}],
     ...
     "look": 'Minimalistisch, veel witruimte, professionele fotografie en 3D-renders.'},
    {"naam": 'UnaBo', "sector": 'Bouw — coördinatieplatform', "web": 'https://unabo.be', "typo": 'Open Sans', "bron": 'CSS-variabelen van de site + computed styles',
     "kleuren": [{"hex": "#7272ff", "rol": "Paars — primair (--alg-primary)"}, {"hex": "#610f7f", "rol": "Diep paars — secundair"}, {"hex": "#8585bd", "rol": "Gedempt paars — ondersteunend"}, {"hex": "#2e2545", "rol": "Bijna-zwart — tekst/logo"}],
     "pos": 'Alle bouwdiensten onder één dak: EPB/EPC/ventilatie, 3D-scanning, vergunningen, stabiliteitsstudies, veiligheidscoördinatie.',
     "tone": "Professioneel maar toegankelijk: 'één aanspreekpunt, één scherpe offerte'.",
     "look": 'Paars als handelsmerk (knoppen, illustraties) op wit, met bijna-zwarte typografie. Clean en corporate.'},
    {"naam": 'Corenbo', "sector": 'Bouw — expertsplatform', "web": 'https://corenbo.be', "typo": 'Sans', "bron": 'WordPress-paletvariabelen van de site',
     "kleuren": [{"hex": "#d8613c", "rol": "Terracotta — accent"}, {"hex": "#c2a990", "rol": "Zand — secundair"}, {"hex": "#cfcabe", "rol": "Beige — basis"}, {"hex": "#b1c5a4", "rol": "Saliegroen — accent"}, {"hex": "#b5bdbc", "rol": "Grijsgroen — neutraal"}],
     "pos": 'Erkende bouwexperts: veiligheidscoördinatie, EPC/energieprestatie, renovatiecoaching, bouwcoördinatie.',
     "tone": "Zakelijk-professioneel, vertrouwen: 'Samen sterk in bouwexpertise' — efficiënt, correct, doordacht.",
     "look": 'Warm, natuurlijk aardepalet (terracotta, zand, salie) — rustig en vertrouwenwekkend.'},
    {"naam": 'Contrax', "sector": 'Back-office voor de bouw', "web": 'https://www.contrax.be', "typo": 'Sora', "bron": 'Elementor global colors + logo-analyse',
     "kleuren": [{"hex": "#5479f7", "rol": "Blauw — primair (Elementor global)"}, {"hex": "#65b8d8", "rol": "Lichtblauw — secundair"}, {"hex": "#184341", "rol": "Donkergroen — diep accent"}, {"hex": "#21232a", "rol": "Bijna-zwart — tekst"}],
     ...
     "look": 'Minimalistisch, veel witruimte, helder blauw als accent op donkere basis.'},
    {"naam": 'Energie Efficiënt', "sector": 'Energie / EPB-support', "web": 'https://energie-efficient.be', "typo": 'Poppins', "bron": 'CSS-variabelen van de site + logo-analyse (562px groen)',
     "kleuren": [{"hex": "#43b191", "rol": "Groen — primair (--primary-color)"}, {"hex": "#3eb08f", "rol": "Logogroen — blad/woordmerk"}, {"hex": "#d2d24b", "rol": "Okergeel — secundair (--fs-color-secondary)"}, {"hex": "#2b2b2b", "rol": "Donkergrijs — tekst"}],
     ...
     "look": 'Groen als handelsmerk met okergele accenten; hexagon-vormtaal, veel witruimte. GEEN rood in de huisstijl.'},
    {"naam": 'Harmoniebouw', "sector": 'Bouw — ruwbouwaannemer', "web": 'https://www.harmoniebouw.be', "typo": 'Sans (Enfold-thema)', "bron": 'thema-accentkleur in CSS + visuele controle van het logo',
     "kleuren": [{"hex": "#de4528", "rol": "Oranje/roest — accent, primair merkteken"}, {"hex": "#111111", "rol": "Zwart — woordmerk 'Harmonie'"}, {"hex": "#ffffff", "rol": "Wit — basis"}, {"hex": "#515151", "rol": "Grijs — bodytekst"}],
     "pos": 'Ruwbouwaannemer (afbraak, steunbalken, ramen/deuren) voor renovatie, aanbouw en nieuwbouw; regio Leuven.',
     "tone": "Zakelijk-benaderbaar, betrouwbaar, adviserend: 'partner in jouw ruwbouwproject'.",
     "look": "Wit met zwart woordmerk en oranje/roest accent ('BOUW'); natuurlijke projectfotografie."},
    {"naam": 'TKN-Buro', "sector": 'Ingenieurs- / tekenbureau stabiliteit', "web": 'https://www.tkn-buro.be', "typo": 'Geometrisch sans', "bron": 'logo-analyse (dominante kleuren)',
     "kleuren": [{"hex": "#cea718", "rol": "Goud/oker — primair (logo)"}, {"hex": "#352910", "rol": "Donkerbruin — logo/tekst"}, {"hex": "#604c14", "rol": "Brons — secundair"}, {"hex": "#ffffff", "rol": "Wit — basis"}],
     "pos": 'Tekenbureau stabiliteit: bekistings-, wapenings- en funderingsplannen als onderaannemer voor ingenieurs/architecten.',
     "tone": "Direct, zakelijk, discreet. Hyper-specialist: 'we doen één ding en doen het goed'.",
     "look": 'Goud/oker met donkerbruin-zwart; strak en technisch, weinig opsmuk.'},
    {"naam": 'Elevait NV', "sector": 'AI / administratie-automatisering (SR)', "web": 'https://elevaitnv.com', "typo": 'Inter', "bron": 'CSS-variabelen van de site',
     "kleuren": [{"hex": "#059669", "rol": "Groen — accent (--color-accent)"}, {"hex": "#e7f4ef", "rol": "Lichtgroen — vlak"}, {"hex": "#e6e3db", "rol": "Warm beige — basis"}, {"hex": "#6b6960", "rol": "Warm grijs — tekst"}],
     "pos": 'Automatiseert administratieve processen (facturatie, verwerking) voor bedrijven en overheden in Suriname met AI.',
     "tone": "Modern, helder, zelfverzekerd: 'Administratie die zichzelf doet'.",
     "look": 'Warm beige/grijs met groen accent; clean moderne UI, tech-gedreven.'},
]
